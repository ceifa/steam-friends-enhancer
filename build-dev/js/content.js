...
Object.defineProperty(exports, "__esModule", { value: true });
exports.sendComments = void 0;
const Proxy_1 = __webpack_require__(/*! ../injected/Proxy */ "./src/injected/Proxy.ts");
const wait = (ms) => new Promise(resolve => setTimeout(resolve, ms));
const getSessionId = () => __awaiter(void 0, void 0, void 0, function* () {
    const sessionid = yield Proxy_1.executeOnPageRealm(() => window.g_sessionID);
    if (!sessionid) {
        throw new Error('Steam session id not found');
    }
    return sessionid;
});
exports.sendComments = ({ logger = console.log, steamids, comment }) => __awaiter(void 0, void 0, void 0, function* () {
    const sessionid = yield getSessionId();
    logger(`Sending comment to ${steamids.length} friends:`, comment);
    let i = 0;
    // TODO: Split this function
    const send = (sid) => new Promise((resolve) => {
        const commentToSend = comment.replace(/\{name\}/g, document.querySelector(`[data-steamid='${sid}'] .friend_block_content`).childNodes[0].textContent);
...
Object.defineProperty(exports, "__esModule", { value: true });
const CommentSender_1 = __webpack_require__(/*! ./CommentSender */ "./src/content/CommentSender.ts");
const jquery_1 = __importDefault(__webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"));
const manageButtonsContainer = document.querySelector('#manage_friends div:nth-child(2)');
...
const postManageButtonsContainer = document.querySelector('#manage_friends div:nth-child(3)');
...
document.getElementById('post-comment-btn').addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
    const steamids = [];
    // TODO: Stop using jQuery
    jquery_1.default("#search_results>.selectable.selected:visible").each((i, ele) => {
        steamids.push(jquery_1.default(ele).data('steamid'));
    });
    const commentElement = document.getElementById("post-comment-text");
    const comment = commentElement.value;
    if (comment && steamids.length > 0) {
        yield CommentSender_1.sendComments({
            steamids,
            comment
        });
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.executeOnPageRealm = void 0;
const resolvers = {};
...
const initializeIfNeeded = () => {
    if (!isInitialized) {
        ...
        window.addEventListener("message", (message) => {
            var _a;
            const identifier = (_a = message === null || message === void 0 ? void 0 : message.data) === null || _a === void 0 ? void 0 : _a.identifier;
            if (identifier) {
...
exports.executeOnPageRealm = (func) => new Promise((resolve) => __awaiter(void 0, void 0, void 0, function* () {
    yield initializeIfNeeded();
